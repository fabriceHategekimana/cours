...
silent! normal! zE
let s:l = 25 - ((8 * winheight(0) + 13) / 26)
...
wincmd w
argglobal
if bufexists("affichageTP3.s") | buffer affichageTP3.s | else | edit affichageTP3.s | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F2> :call Note("s")
nnoremap <buffer> <F5> :call RunARM()
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((22 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
wincmd w
argglobal
if bufexists("reste.md") | buffer reste.md | else | edit reste.md | endif
let s:cpo_save=&cpo
set cpo&vim
