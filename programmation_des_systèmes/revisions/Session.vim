...
silent only
cd ~/cours/programmation_des_systèmes/revisions
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +6 note.md
badd +3 ~/cours/programmation_des_systèmes/revisions/programmeur.md
badd +5 ~/cours/programmation_des_systèmes/revisions/informatiques.md
badd +5 ~/cours/programmation_des_systèmes/revisions/questions.md
argglobal
silent! argdel *
$argadd note.md
edit ~/cours/programmation_des_systèmes/revisions/informatiques.md
