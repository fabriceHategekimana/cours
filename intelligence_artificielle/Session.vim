...
silent only
silent tabonly
cd ~/cours/intelligence_artificielle
...
%argdel
$argadd note/note.md
edit ~/cours/intelligence_artificielle/note/Méthode_de_recherche.md
...
normal! 077|
tabnext 1
badd +40 note/note.md
badd +0 ~/cours/intelligence_artificielle/note/Méthode_de_recherche.md
