...
tabnext 1
badd +5 note/note.md
badd +9 ~/cours/AN/note/printemps.md
badd +15 ~/cours/AN/note/énoncez_et_démontrer_le_théorème_de_la_factorisation_QR_réduite.md
badd +1 ~/cours/AN/note/Gram_Schmidt.md
badd +3 ~/cours/AN/note/définir_la_réflexion_de_Householder_et_determiner_Hv_avec_v_donné.md
