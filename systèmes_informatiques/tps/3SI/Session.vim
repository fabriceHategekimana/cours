...
silent only
silent tabonly
cd ~/cours/systèmes_informatiques/tps/3SI
...
nnoremap <buffer> <F6> :! gcc *.c -o main && ./main
xnoremap <buffer> <F5> y:call RunCPart()
nnoremap <buffer> <F5> :call RunC()
nnoremap <buffer> <F2> :call Note("c")
inoremap <buffer>  /_s
...
inoremap <buffer> print printf("%d",);<Left><Left>
let &cpo=s:cpo_save
unlet s:cpo_save
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 152 - ((12 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
152
