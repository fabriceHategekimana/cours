...
silent only
silent tabonly
cd ~/cours/reseaux_informatiques
...
%argdel
$argadd note/note.md
edit ~/cours/reseaux_informatiques/note/questions.md
...
badd +1 ~/cours/reseaux_informatiques/note/examen.md
badd +4 ~/cours/reseaux_informatiques/note/Linklayer.md
badd +5 ~/cours/reseaux_informatiques/note/questions.md
badd +1 ~/cours/reseaux_informatiques/note/Stop_and_Wait.md
badd +11 ~/cours/reseaux_informatiques/note/Go_Back_N.md
badd +7 ~/cours/reseaux_informatiques/note/Selective_Repeat.md
badd +2 ~/cours/reseaux_informatiques/note/remarque.md
