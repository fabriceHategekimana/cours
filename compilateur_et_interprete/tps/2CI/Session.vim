...
silent only
silent tabonly
cd ~/cours/compilateur_et_interprete/tps/2CI
...
set winwidth=1
argglobal
if bufexists("pile.py") | buffer pile.py | else | edit pile.py | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F6> :call RunPythonLess()
xnoremap <buffer> <F5> y:call RunPythonPart()
...
set winwidth=1
argglobal
if bufexists("fenetre.py") | buffer fenetre.py | else | edit fenetre.py | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F6> :call RunPythonLess()
xnoremap <buffer> <F5> y:call RunPythonPart()
